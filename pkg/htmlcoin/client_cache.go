...
const (
	HtmlcoinMethodGetblock             = "getblock"
	HtmlcoinMethodGetblockhash         = "getblockhash"
	HtmlcoinMethodGetblockheader       = "getblockheader"
	HtmlcoinMethodGetblockchaininfo    = "getblockchaininfo"
	HtmlcoinMethodGethexaddress        = "gethexaddress"
	HtmlcoinMethodGetrawtransaction    = "getrawtransaction"
	HtmlcoinMethodGettransaction       = "gettransaction"
	HtmlcoinMethodGettxout             = "gettxout"
	HtmlcoinMethodDecoderawtransaction = "decoderawtransaction"
)

var cachable_methods = []string{
	HtmlcoinMethodGetblock,
	// HtmlcoinMethodGetblockhash,
	// HtmlcoinMethodGetblockheader,
	// HtmlcoinMethodGetblockchaininfo,
	HtmlcoinMethodGethexaddress,
	HtmlcoinMethodGetrawtransaction,
	// HtmlcoinMethodGettransaction,
	HtmlcoinMethodGettxout,
	HtmlcoinMethodDecoderawtransaction,
}
