...
func TestGetTransactionByHashRequestWithContractVout(t *testing.T) {
	...
	testsArray := []testData{
		{
			// Using data from https://htmlcoin.info/tx/d20c5c31536e60decf175caf2cbfba980c3678c0f4b201c9b9fa1440102e6451
	...
	for _, test := range testsArray {
		mockedClientDoer := internal.NewDoerMappedMock()
		htmlcoinClient, _ := internal.CreateMockedClient(mockedClientDoer)
			...
			[]*htmlcoin.DecodedRawTransactionOutV{
				{
					Value: decimal.Zero,
					N:     0,
					ScriptPubKey: htmlcoin.DecodedRawTransactionScriptPubKey{
						Hex:       test.VoutHex,
						Addresses: []string{},
					},
				},
...
func TestGetTransactionByHashRequestWithOpSender(t *testing.T) {
	//? Using data from https://htmlcoin.info/tx/0425fa39feed4cd6c93998159901095c147f8b0043823067dc1d25dabf950ac9
	//preparing request
