...
var DefaultGasAmountForHtmlcoin = big.NewInt(250000)

// HTMLCOIN default gas value (also the minimum gas) in wei
...
func (r *SendTransactionRequest) UnmarshalJSON(data []byte) error {
	...
	*r = SendTransactionRequest(params[0])
	...
	if r.Gas == nil {
		...
		// HTMLCOIN: (numeric or string, optional) gasLimit, default: 250000, max: 40000000
		r.Gas = &ETHInt{DefaultGasAmountForHtmlcoin}
	}

	if r.GasPrice == nil {
		// ETH: (optional, default: To-Be-Determined) Integer of the gasPrice used for each paid gas
		// HTMLCOIN: (numeric or string, optional) gasPrice Htmlcoin price per gas unit, default: 0.0000004, min:0.0000004
