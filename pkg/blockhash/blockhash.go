...
import (
	...
	blockHashLog "github.com/denuoweb/ethereum-block-processor/log"
)
...
func (bh *BlockHash) GetHtmlcoinBlockHash(ethereumBlockHash string) (*string, error) {
	return bh.GetHtmlcoinBlockHashContext(nil, ethereumBlockHash)
}
